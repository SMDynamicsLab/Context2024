...
#from plotnine import scale_color_brewer, scale_fill_cmap, scale_color_cmap, scale_color_cmap_d
...
def Group_Condition_Mean_Postperturb_Transient(data_GroupSubjCond_OS_df):
    ...
    data_GSC_OS_df.query("(Relative_beep >= 1 & Relative_beep <= 6) & (Perturb_size == -50 | Perturb_size == 50)", inplace=True)
    ...
    data_GSC_OS_df.insert(2, 'Experiment_sign', np.where(data_GSC_OS_df['Perturb_size']==50,'pos','neg'))
