...
perturb_type_dictionary = {'SC':0, 'PS':1}														      # Perturbation type dictionary. 0--> Step change. 1--> Phase shift.                                     
perturb_size_dictionary = {'neg2':-20, 'iso':0, 'pos2':20}										      # Perturbation size dictionary.
